	...
	return (
		<AlertDialog>
			<DropdownMenuContent align="end" className="w-[160px]">
				...
				<DropdownMenuItem
					disabled={Session?.user.role === "USER" || (place.verified && Session?.user.role !== "OWNER")}
					onClick={() =>
						verifyPlaceAction({
							placeId: place.id,
				...
				<DropdownMenuItem>
					<AlertDialogTrigger className="cursor-pointer w-full text-left">Edit</AlertDialogTrigger>
				</DropdownMenuItem>
			</DropdownMenuContent>
			<AlertDialogContent>
				<EditPlaceForm
