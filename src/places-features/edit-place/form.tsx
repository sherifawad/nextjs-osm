  ...
  return (
    <Form {...form}>
      <form
        ...
        className="w-full space-y-8 bg-background"
      >
        <AlertDialogHeader>
            ...
            <FormField
              ...
              render={({ field: { value, onChange, ...fields } }) => (
                <FormItem className="flex items-center gap-x-3 ">
                  <FormLabel
                    className={`mt-2 ${value ? "text-green-600" : ""}`}
                  >
                    Verified
                  </FormLabel>
                  <FormControl>
                    <Checkbox
                      ...
                      className={`${
                        value
                          ? "data-[state=checked]:bg-secondary data-[state=checked]:text-green-600"
                          : ""
                      }`}
                      disabled={
                        successfulSubmit ||
                        (place.verified && userRole !== "OWNER")
                      }
                    />
                  </FormControl>
                  <FormMessage />
