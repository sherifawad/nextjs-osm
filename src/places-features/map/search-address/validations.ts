...
/////////////////////////////////////////
type NominatedPlaceSuccessResponse = { status: "success"; data: NominatedPlace[] };
type NominatedPlaceErrorResponse = { status: "error"; errors: Partial<SearchAddressesErrorsSchemaErrors> };

export type NominatedPlaceResponse = NominatedPlaceSuccessResponse | NominatedPlaceErrorResponse;
