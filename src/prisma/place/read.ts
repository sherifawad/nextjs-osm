...
export const getUserPlacesDbPrisma = async (
  ...
  try {
    ...
    if (validData.search && validData.columnToFilter) {
      whereData = {
        ...whereData,
        [validData.columnToFilter as unknown as string]: {
    ...
    if ((validData.columnToSort as unknown as string) === "rating") {
      sortData = {
        ...sortData,
        rating: {
      ...
      sortData = {
        ...sortData,
        [validData.columnToSort as unknown as string]: validData.sorting,
      };
    }
...
export const getUserPlacesCountDbPrisma = async (
  ...
  try {
    ...
    if (validData.search && validData.columnToFilter) {
      whereData = {
        ...whereData,
        [validData.columnToFilter as unknown as string]: validData.search,
      };
    }
    whereData = {
      ...whereData,
